...
from lib.data_loader import AG, cuda_collate_fn
...
dataloader = torch.utils.data.DataLoader(AG_dataset, shuffle=False, num_workers=4, collate_fn=cuda_collate_fn)

gpu_device = torch.device('cuda:0')
object_detector = detector(train=False, object_classes=AG_dataset.object_classes, use_SUPPLY=True).to(device=gpu_device)
object_detector.eval()


model = STTran(mode="sgdet",
