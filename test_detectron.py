...
if __name__=="__main__":
    ...
    cfg.DATASETS.TEST = ("action-genome-test",)
    ...
    evaluator = COCOEvaluator("action-genome-test", output_dir="./output")
    predictor = DefaultPredictor(cfg)
    val_loader = build_detection_test_loader(cfg, "action-genome-test")
